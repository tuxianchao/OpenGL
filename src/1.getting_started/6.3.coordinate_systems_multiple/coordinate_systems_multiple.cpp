...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "coordinate_systems_multiple", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("coordinate_systems_multiple.vs", "coordinate_systems_multiple.fs");
