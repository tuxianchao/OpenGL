...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "camera_keyboard_zoom", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("camera_keyboard_zoom.vs", "camera_keyboard_zoom.fs");
