...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "transformations_exercise2", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("transformations_exercise2.vs", "transformations_exercise2.fs");
