...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "textures_exercise3", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("textures_exercise3.vs", "textures_exercise3.fs");
