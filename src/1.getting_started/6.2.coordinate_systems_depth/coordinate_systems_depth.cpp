...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "coordinate_systems_depth", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("coordinate_systems_depth.vs", "coordinate_systems_depth.fs");
