...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow *window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "textures_exercise4", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader("textures_exercise4.vs", "textures_exercise4.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::NewLine();
            ImGui::SliderFloat("mixAlphaValue", &mixAlphaValue, 0.0f, 1.0f);
            ImGui::End();
        }
        ...
        shader.use();
        shader.setFloat("u_MixAlpha", mixAlphaValue);
        glBindVertexArray(VAO);
