...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "multiple_lights_horror", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("multiple_lights_horror.vs", "multiple_lights_horror.fs");
