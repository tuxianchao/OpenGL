...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "light_casters_directional", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("light_casters_directional.vs", "light_casters_directional.fs");
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::SliderFloat3("light_direction", (float*)&light_direction, -10.0f, 10.0f);
