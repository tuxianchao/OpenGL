...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "basic_lighting_practice3", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("basic_lighting_practice3.vs", "basic_lighting_practice3.fs");
