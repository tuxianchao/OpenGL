...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "light_map_diffuse", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("light_map_diffuse.vs", "light_map_diffuse.fs");
