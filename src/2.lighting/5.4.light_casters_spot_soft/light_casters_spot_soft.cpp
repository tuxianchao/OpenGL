...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "light_casters_spot_soft", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("light_casters_spot_soft.vs", "light_casters_spot_soft.fs");
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::SliderFloat3("light_constant", (float*)&light_constant, -10.0f, 10.0f);
            ImGui::SliderFloat3("light_linear", (float*)&light_linear, -10.0f, 10.0f);
            ImGui::SliderFloat3("light_quadratic", (float*)&light_quadratic, -10.0f, 10.0f);
            ImGui::SliderFloat3("light_cutOff",   (float*)&light_cutOff, 0.0f, 100.0f);
            ImGui::SliderFloat3("light_outerCutOff", (float*)&light_outerCutOff,0.0f, 100.0f);
        ...
        lightingShader.setFloat("light.constant", light_constant);
        lightingShader.setFloat("light.linear", light_linear);
        lightingShader.setFloat("light.quadratic", light_quadratic);

        lightingShader.setVec3("light.position", camera.m_position);
        lightingShader.setVec3("light.direction", camera.m_front);
        lightingShader.setFloat("light.cutOff", glm::cos(glm::radians(light_cutOff)));
        lightingShader.setFloat("light.outerCutOff", glm::cos(glm::radians(light_outerCutOff)));
