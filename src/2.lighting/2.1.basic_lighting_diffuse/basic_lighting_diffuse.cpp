...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "basic_lighting_diffuse", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("basic_lighting_diffuse.vs", "basic_lighting_diffuse.fs");
