...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "materials_practice", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("materials_practice.vs", "materials_practice.fs");
