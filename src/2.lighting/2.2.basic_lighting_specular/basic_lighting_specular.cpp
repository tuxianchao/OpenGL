...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "basic_lighting_specular", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("basic_lighting_specular.vs", "basic_lighting_specular.fs");
