...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "light_casters_point", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("light_casters_point.vs", "light_casters_point.fs");
