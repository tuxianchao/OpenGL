...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "multiple_lights_factory", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("multiple_lights_factory.vs", "multiple_lights_factory.fs");
