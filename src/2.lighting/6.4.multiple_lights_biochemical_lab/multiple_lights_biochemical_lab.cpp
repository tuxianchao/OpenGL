...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "multiple_lights_biochemical_lab", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("multiple_lights_biochemical_lab.vs", "multiple_lights_biochemical_lab.fs");
