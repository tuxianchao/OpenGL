...
int main()
{
    ...
    // create glfw window
    // =================
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "light_casters_spot", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lightingShader("light_casters_spot.vs", "light_casters_spot.fs");
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::SliderFloat3("light_cutOff",   (float*)&light_cutOff, -10.0f, 10.0f);
