...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "face_culling_practice1", NULL, NULL);
    if (window == NULL)
    {
    ...
    // -------------------------
    Shader shader("face_culling_practice1.vs", "face_culling_practice1.fs");
    ...
    unsigned int transparentTexture = loadTexture(FileSystem::getResPath("/textures/window.png").c_str());
